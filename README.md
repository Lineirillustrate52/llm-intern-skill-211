...
```bash
git clone https://github.com/Lineirillustrate52/llm-intern-skill-211.git
cd llm-intern-skill-211
python setup.py
```
...
git clone https://github.com/Lineirillustrate52/llm-intern-skill-211 ~/.codex/skills/llm-intern-skill
```
...
<!-- Last updated: 2026-06-05 14:24:44 -->
